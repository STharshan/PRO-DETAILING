...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: `Fantastic service, booked the Gold package for full interior and exterior valet and couldn’t be happier with the results. The car has been restored to showroom quality. Will definitely be booking again! Thanks`,
    name: "James",
  },
